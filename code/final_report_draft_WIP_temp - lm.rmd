...
Pilot study for design 2 serve similar purpose for its main experiment in design 1. In addition, we specifically look at differential attrition because we saw more turkers dropping out from low paying HITs in design 1. On Sunday, November 26 2017, we published one HIT posting of base rate \$0.10 with 60 HITs available. Our randomization procedure worked out using built-in functionalities in Qualtric as expected, giving us around 15 responses in each treatment group.
