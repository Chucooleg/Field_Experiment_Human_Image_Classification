...
\bigskip
\centerline{\bfseries R X(0.10) O}
\centerline{\bfseries }
\centerline{\bfseries R X(0.25) O}
\centerline{\bfseries }
\centerline{\bfseries R X(0.40) O}
\centerline{\bfseries }
\centerline{\bfseries R X(0.55) O}
\bigskip
...
For both experiments, we took specific cautions in our execution protocol. Our pilots results indiciated that although the pool size of Amazon turkers is in the order of hundred thousands, several turkers managed to find and submit our HIT for again but for a different pay rate. 
